...
def parse():
    ...
    parser.add_argument('--sup', type=str, default='cls')
    ...
    parser.add_argument("--train_iter", type=int, default=65000)
    ...
    parser.add_argument("--PAM", default=" ")
...
def validate():
    ...
    for img, cls_label, fname, tsize in tqdm(valid_loader):
