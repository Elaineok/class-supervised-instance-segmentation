...
class VOCDataset(Dataset):
    def __init__(self, datalist_file, root_dir, pam, num_classes=20, 
        ...
        self.dat_list = self.read_labeled_image_list(root_dir, pam, datalist_file)
    ...
    def read_labeled_image_list(self, root_dir, pam, data_list):
...
class VOCTestDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return img, cls_label, fname, (ori_h, ori_w)
